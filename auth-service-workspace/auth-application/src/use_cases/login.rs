...
mod tests {
    ...
    impl UserStore for MockUserStore {
        async fn add_user(&mut self, _user: auth_core::User) -> Result<(), UserStoreError> {
            unimplemented!()
        }
        ...
        async fn get_user(&self, _email: &Email) -> Result<auth_core::User, UserStoreError> {
            unimplemented!()
        }
    ...
    impl TwoFaCodeStore for MockTwoFaCodeStore {
        ...
        async fn delete(&mut self, _user_id: &Email) -> Result<(), TwoFaCodeStoreError> {
            unimplemented!()
        }
    }
    ...
    async fn test_login_without_2fa() {
        ...
        let two_fa_store = Arc::new(RwLock::new(MockTwoFaCodeStore));
